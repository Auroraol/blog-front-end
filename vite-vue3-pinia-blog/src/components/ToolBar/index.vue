...
<template>
  ...
  <el-dialog v-model="topicDialog" title="Tips" width="30%">
    ...
    <template #header>
      <div
        style="display: flex; align-items: center   font-family: 'LXGW WenKai'
  font-weight: normal;"
      >
        <svg-icon
          name="custom"
    ...
    <div class="list">
      ...
      <div
        class="item"
        style="backgroundcolor: #fa6946"
        @click="color = '#fa6946'"
      ></div>
      <div
        class="item"
        style="backgroundcolor: #fab64f"
        @click="color = '#fab64f'"
      ></div>
      <div
        class="item"
        style="backgroundcolor: #44b6a0"
        @click="color = '#44b6a0'"
      ></div>
      <div
        class="item"
        style="backgroundcolor: #30362f"
        @click="color = '#30362f'"
      ></div>
      <div
        class="item"
        style="backgroundcolor: #dc382f"
        @click="color = '#dc382f'"
      ></div>
      <div
        class="item"
        style="backgroundcolor: #a18acd"
        @click="color = '#a18acd'"
      ></div>
    </div>
